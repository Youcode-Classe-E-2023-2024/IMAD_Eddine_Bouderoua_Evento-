...
export default function Register({onChangeX}){
  ...
  >
    ...
    <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
      <div>
        <label className="font-semibold text-sm text-gray-400 pb-1 block">Full Name</label>
        <input
          className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-black focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          type="text"
          id="fullname"
      ...
      <div>
        <label className="font-semibold text-sm text-gray-400 pb-1 block">Email</label>
        <input
          className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-black focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          type="email"
          id="email"
      ...
      <div>
        <label className="font-semibold text-sm text-gray-400 pb-1 block">Username</label>
        <input
          className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-black focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          type="text"
          id="username"
      ...
      <div className="mt-5">
        <button
          ...
          className="py-2 px-4 bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-black w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
          type="submit"
        >
          Sign up
        </button>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div
        onClick={()=>{handleButtonClick()}}  className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline"
