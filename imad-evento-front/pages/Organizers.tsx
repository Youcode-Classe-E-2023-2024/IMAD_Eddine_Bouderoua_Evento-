  ...
  function newcomment() {
    ...
    fetch("http://127.0.0.1:8000/api/newcomment", requestOptions)
      ...
      setcomment((prevComments) => {
        ...
        const tmp = { ...updatedComments[0], likes: 0,organizer:localStorage.getItem("stuf"), msg: textareaValue };
  ...
  function requestcat(){
    ...
    fetch("http://127.0.0.1:8000/api/newcomment", requestOptions)
      ...
      fetch("http://127.0.0.1:8000/api/newcatego", requestOptions2)
        ...
        setcomment((prevComments) => {
          const updatedComments = [...prevComments];
          const tmp = { ...updatedComments[0], likes: 0,organizer:localStorage.getItem("stuf"), msg: `Requested The Categorie ${textareaValue}` };
          updatedComments.push(tmp);
            ...
            <div className=" w-full h-full ">
               ...
               
                {
                  !data ? (
                    ...
                    <>
                    <div className="cardo z-40">
                      <div className="skeleton bg-gray-900"></div>
